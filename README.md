...
Code listed in the `src/` directory consists of userscripts and stylesheets that are used on the Utaite Wiki and are licensed under the [Creative Commons Attribution-ShareAlike 4.0 (CC-BY-SA 4.0) license](src/LICENSE.md).
...
GIT_REPOSITORY_URL=https://github.com/arknokiseki/UtaiteWikiInterfaceCode
...
WIKI_API_URL=https://utaite.wiki/w/api.php
